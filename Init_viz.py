...
data = pd.read_csv('https://raw.githubusercontent.com/bobgree1/my_first_app/main/all_data.csv')
...
data.head(10)
lb = pd.read_csv('https://raw.githubusercontent.com/bobgree1/my_first_app/main/Comp_name.csv', index_col=0)
...
sc = pd.read_csv('https://raw.githubusercontent.com/bobgree1/my_first_app/main/ScoreData.csv')
...
output_card = dbc.Card(
    [
        ...
        dbc.CardBody(html.H3(id="predicted-grade", style={"text-align": "center"})),
    ]
)
...
app.layout = dbc.Container(
    ...
    children=[
                    ...
                    [sample_controls,
                     ...
                     DataTable(
                         ...
                         style_cell_conditional=[
                                {'if': {'column_id': 'score'},
                                 'width': '12%'},
                                {'if': {'column_id': 'gpr_inc_2018'},
                                 'width': '20%'},
                                {'if': {'column_id': 'eps_2019'},
                                 'width': '16%'},
                                {'if': {'column_id': 'score '},
                                 'width': '11%'},
                        ]
        ...
        dbc.Row([dbc.Col(dcc.Graph(id='2D', style={'height': '500px'}), width=4),
                 dbc.Col(dcc.Graph(id='score_summary', style={'height': '500px'}), width=2),
                 dbc.Col(dcc.Graph(id="3D", style={'height': '500px'}), width=6)]),
...
def vis_summary(hi):
    ...
    fig.update_layout({'legend_orientation': 'h'}, xaxis_range=[-0.25, 1.25], )
